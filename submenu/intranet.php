 ...
 <div class="contenedor" >
 	...
 	<ul class="sub-menu">
 		...
 		<div id="formulario-intranet">
 			...
 			<div class="card-body">	
 				<form method="post" action="demo.php" class="form-group" autocomplete="off" id="formintra">
 					<div class="opcion">
 				...
 				<div class="card-footer">
 					<button type="button" id="but_submit"  value="ingresar" class="btn btn-dark" >Ingresar</button>
 					<button type="reset"  class="btn btn-dark">cancelar  </button>  
 					
 					<br>
 					<div style="text-align: center;"><a href="intraRegister.php">Registrate !</a><br>
 						<a href="intra_recupContra.php">¿Olvidaste la contraseña?</a>
 					</div>
	  			...
	  			$(document).ready(function(){
	  				$("#but_submit").click(function(){
	  					...
	  					$.ajax({
	  						...
	  						type:'post',
	  						data:{
	  							"numero2":username,"clave":password,"tipo":tipo},
