...
define('SECRET_SALT','XrHgQKuomOwSRoWBuBwfhC2AhNSDyAyS');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','enpo1972@gmail.com');
...
define('DBNAME','briane19_Ossupervan');
define('DBUSER','briane19_adminti');
define('DBPASS','123456super');
